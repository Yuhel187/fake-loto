    ...
    <DialogPortal>
        ...
        >
            ...
            <DialogPrimitive.Close
                ...
                className="rounded-full w-8 h-8 flex items-center justify-center opacity-60 hover:opacity-100 hover:bg-gray-100 transition-all focus:outline-none disabled:pointer-events-none"
            >
                <X className="h-4 w-4" />
